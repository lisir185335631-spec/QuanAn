  ...
  getDetail: adminProcedure
    ...
    .query(async ({ input }) => {
      ...
      return {
        ...
        variantConfig: experiment.variantConfig as Record<string, unknown>,
        trafficAllocation: experiment.trafficAllocation as Record<string, number>,
        startedAt: experiment.startedAt,
        stoppedAt: experiment.stoppedAt,
        resultSummary: experiment.resultSummary as Record<string, unknown> | null,
