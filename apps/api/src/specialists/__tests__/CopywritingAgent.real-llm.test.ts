 ...
 * test_command: RUN_REAL_LLM=1 cd apps/api && pnpm vitest run src/specialists/__tests__/CopywritingAgent.real-llm.test.ts
 */
...
describe.skipIf(skipRealLlm)('CopywritingAgent step7 real LLM', () => {
