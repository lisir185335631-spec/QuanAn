 ...
 * PRD-8 US-002 · AC-7: EvolutionAgent / DailyTaskAgent
 */
...
import { DEEP_LEARN_TEMPLATE }        from './deep-learn';
...
import { PRESENTATION_TEMPLATE }      from './presentation';
import { PRIVATE_DOMAIN_TEMPLATE }    from './private-domain';
...
/** Specialist → 模板映射 (PRD-4 × 7 + PRD-5 AnalysisAgent + PRD-6 VideoAgent 3 mode + PRD-8 3 L5 + PRD-27 3 Specialist) */
export const SPECIALIST_TEMPLATES: Partial<Record<SpecialistId, SpecialistTemplate>> & Record<string, SpecialistTemplate> = {
  ...
  // PRD-27 US-002 · AC-4: 3 绕过 Specialist 接通 ContextAssembler
  DeepLearnAgent:      DEEP_LEARN_TEMPLATE,
  PresentationAgent:   PRESENTATION_TEMPLATE,
  PrivateDomainAgent:  PRIVATE_DOMAIN_TEMPLATE,
};
