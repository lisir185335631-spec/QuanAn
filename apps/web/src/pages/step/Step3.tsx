  ...
  return {
    ...
    bioEntries: [
      ...
      },
      {
        ...
        seoKeywords: ['AI学习', '创业感悟', '个人成长', '直播', '转型故事'],
      },
      {
        ...
        evaluation: '',
        structureExplain: [
          '第一行：核心身份与定位，带表情符号吸引注意。',
          '第二行：明确AI的双重价值，引发共鸣。',
          '第三行：分享内容方向，突出干货属性。',
          '第四行：针对小红书种草属性，提供解决方案。',
          '第五行：行动号召，引领向往。',
        ],
        seoKeywords: ['AI智能体', 'AI工作流', '企业降本增效', 'OPC创业避坑', 'AI生产力'],
      },
      {
        platformKey: 'xhs_personal',
        platformLabel: '小红书（副号）：创始人IP号',
        copy: '高总：12年餐饮老板，AI赛道二次创业者。\n我的AI学习笔记 | 创业思考 | 个人成长。\n从负债百万到AI智能体公司创始人，真实故事。\n不只是创业，持续进阶，永远在路上。\n评论区聊聊你的AI创业困惑。',
        hashtags: [],
        evaluation: '',
        structureExplain: [
          '第一行：个人身份与账号定位。',
          '第二行：分享内容方向，偏向个人感悟与思考。',
          '第三行：核心人生经历，增强故事感。',
          '第四行：个人价值观表达，吸引同频。',
          '第五行：互动引导，真实倾听。',
        ],
        seoKeywords: ['创业故事', '个人IP', '商业思考', '转型故事', '创始人'],
      },
      {
        ...
        seoKeywords: ['智能体定制专家', '企业AI工作流', '客户案例', '已服务多家', 'AI解决方案'],
      },
      {
        platformKey: 'sph_life',
        platformLabel: '视频号（副号）：个人生活号',
        copy: '高总：我的AI创业日常 + 生活感悟。\n分享：AI学习干货 | 商业洞察 | 个人成长。\n❤️链接餐饮，创业生态，共启新征程。\n从餐饮到AI，持续突破，永不设限。\n点赞关注，一起探索AI的无限可能。',
        hashtags: [],
        evaluation: '',
        structureExplain: [
          '第一行：具体身份与账号内容定位。',
        ...
        seoKeywords: ['AI创业日常', '生活感悟', '跨界创业', '商业洞察', '微信生态'],
      },
    ],
