...
// STEP4B_TEXTAREA · 产品/服务描述 · 必填 textarea · spec §7.5 line 1527
export const STEP4B_TEXTAREA: Step4bTextarea = {
  id: 'product_description',
  label: '产品/服务描述',
  required: true,
  placeholder:
    '描述你的产品或服务，比如：美容院皮肤管理项目，客单价500-3000元 / 线上知识付费课程，定价199-999元 / 实体店+线上双渠道',
};

// STEP4B_INPUTS_3 · 3 可选输入项字面 1:1 来源 spec §7.5 line 1528-1530
...
// STEP4B_OUTPUT_H3_5 · 5 H3 输出区字面 1:1 · 来源 spec §7.5 SOP + 输出模块命名
