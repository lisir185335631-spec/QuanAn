...
### Open(0)
**无 open TD!** 这是 QuanQn 项目历史首次 0 open TD 状态。
...
| **TD-021** | Low | US-004 f2afdbc | ImageGen Worker import 自 @quanqn/schemas/specialist-io · grep 0 命中 inline export · 727 vitest |
...
**[PASS]** 8/8 PASS · 100% 覆盖率 · **0 open TD**(QuanQn 项目首次)· 0 RCA · 0 daemon hang
...
grep -q "from '@quanqn/schemas/specialist-io'" apps/api/src/trpc/routers/{videoProduction,acquisitionVideo,aiVideo,copywriting}.ts && ok "4 router import" || fail "import 缺"
