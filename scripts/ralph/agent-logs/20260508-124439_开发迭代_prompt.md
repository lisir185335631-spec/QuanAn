...
- **Story ID**: US-003
- **Title**: 6 新模块 + 3 辅助页占位
- **Description**: /diagnosis /daily-tasks /evolution /accounts /my-topics /history(6 新)+ /knowledge /trending /settings(3 辅助)
- **Priority**: 3
- **Retry Count**: 0
- **Acceptance Criteria**:
  1. 6 新模块页 · /diagnosis 调 trpc.diagnosis.latest · /daily-tasks 占位 · /evolution 调 trpc.evolution.history · /accounts 列 ipAccounts.list · /my-topics 占位 · /history 占位
  2. 3 辅助页 · /knowledge 调 knowledge.getRecommendations · /trending 调 trending.fetch · /settings 占位
  3. 全 Aurelian Dark + shadcn
  4. Typecheck passes
  5. Tests pass · ≥ 3 unit(关键页渲染)
