...
- **Description**: 内容审核员 / super_admin · /admin/reviewDeepLearn · 列表 + 抽屉 framework · 文件 metadata + autoScanResult + redact text 预览 + 用户违规历史。
- **Priority**: 10
- **Retry Count**: 0
- **Acceptance Criteria**:
...
- **教训** (来自 PRD-10+PRD-11+D-075 / DenseTable): react-virtual
  - 反例: `data.map(<tr>)`
  - 正确: `useVirtualizer`
...
- **教训** (来自 PRD-11 retro M-1 / US-007 PATH-B): 大 UI 拆 2 子
  - 反例: `单 US 13 files + 5 Tab`
  - 正确: `part 1 列表+抽屉 / part 2 批量+Tab`
