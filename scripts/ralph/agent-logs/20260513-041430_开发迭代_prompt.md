...
- **Description**: 作为运营 · 打开 admin.quanqn.com/invites 看邀请码列表 + 创建/批量导入按钮 + campaign 分组 Tab + 转化漏斗图 + 详情抽屉。
- **Priority**: 21
- **Retry Count**: 0
- **Acceptance Criteria**:
...
- **教训** (来自 PRD-6 / PRD-6 US-025): Recharts 数据点必含 fill var(--accent-X)
  ...
  - 正确: `{name,value,fill:'var(--accent-X)'}`
...
- **US-020**: adminRouter.invites 6 procedure(list/create/batchImport/invalidate/detail/campaignFunnel) — [OK] 已完成