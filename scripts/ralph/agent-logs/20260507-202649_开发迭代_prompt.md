...
[risk-upgrade] foundation due to downstream=6 (US-002~US-007 全 depend on US-001) · monorepo / shared / __init__ keyword

### [SHIELD] 历史反例 (anti_patterns) — 类似 story 的过往教训, 实现时主动避开:
- **教训** (来自 QuanQn-base / REJ-032): TS strict 模式下不允许 any · 必须 zod schema / generic / interface 显式定义
