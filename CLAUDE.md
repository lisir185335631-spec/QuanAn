# QuanQn · 项目级 AI 协作约束(CLAUDE.md)

> **版本** · v0.1(2026-05-07)
> **范围** · 本文件是 QuanQn 项目内 AI 协作的"短指令" · 跟全局 `~/.claude/CLAUDE.md` 互补
...
QuanQn 是基于 **aiipznt 复刻 + 升级** 的 IP 起号 / 内容创作 SaaS · 1.0 中文版 · 邀请制内测。
...
- **数据库** ·
  - 主开发库 · `quanqn` · DATABASE_URL = `postgresql://return@localhost:5432/quanqn`
  - 测试库 · `quanqn_test` · DATABASE_URL_TEST = `postgresql://return@localhost:5432/quanqn_test`
...
Ralph 套件未到位 · P0-2 跑 `~/.claude/scripts/ralph/sync-to-project.sh /Users/return/Desktop/QuanQn` 一键同步。
...
> - 域名 quanqn.com · ICP 备案 · 增值电信经营许可证(ICP-VAS)
